...
import { Search, Plus, MoreHorizontal, Edit, Trash2, Shield, ShieldCheck, Mail, Phone, Calendar } from "lucide-react"
        ...
        <Dialog open={isAddUserOpen} onOpenChange={setIsAddUserOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>Create a new user account with hosting access.</DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">93.2% of total users</p>
          </CardContent>
        </Card>
